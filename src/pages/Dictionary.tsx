...
const dictionaryColors = ["bg-matcha", "bg-hojicha", "bg-gyokuro", "bg-sencha"];
...
const DICTIONARY_DATA: DictionaryItem[] = [
  {
    ...
    translation: "Herbata",
    description:
      "Po prostu herbata. W Japonii to słowo-klucz, które otwiera drzwi do całej kultury celebracji naparu.",
  },
  {
    kanji: "茶舗",
    romaji: "Chaho",
    ...
    description:
      "To tutaj mistrzowie herbaty (Chashi) dbają o to, by liście były idealnie wyselekcjonowane i zapakowane. Nasza herbata pochodzi prosto z takiego miejsca w Kagoshimie.",
  },
  {
    kanji: "茶碗",
    romaji: "Chawan",
    ...
    description:
      "W przypadku matchy jest ona szeroka i głęboka, by swobodnie operować w niej bambusową miotełką.",
  },
  {
    kanji: "茶筅",
    romaji: "Chasen",
    ...
    description:
      "Niezbędna do przygotowania Matchy. To dzięki niej uzyskasz idealną, sztywną piankę na powierzchni naparu.",
  },
  {
    kanji: "抹茶",
    romaji: "Matcha",
    ...
    description:
      "Herbata w formie drobno zmielonego pyłu. Liście przed zbiorem są zacieniane, co nadaje im intensywny zielony kolor i mnóstwo drogocennych składników.",
  },
  {
    kanji: "焙じ茶",
    romaji: "Hojicha",
    ...
    description:
      "Ma dymny, orzechowo-karmelowy aromat i bardzo niską zawartość kofeiny – idealna na wieczorne hitotoki.",
  },
  {
    kanji: "玉露",
    romaji: "Gyokuro",
    ...
    description:
      "Jedna z najszlachetniejszych herbat. Dzięki procesowi zacieniania krzewów, napar jest gęsty, słodki i pełen smaku umami.",
  },
  {
    kanji: "煎茶",
    romaji: "Sencha",
    ...
    description:
      "Charakteryzuje się idealnym balansem między słodyczą a orzeźwiającą gładką goryczką.",
  },
  {
    kanji: "薄茶",
    romaji: "Usucha",
    ...
    description:
      "To najczęstszy sposób przygotowania Matchy – lekki, codzienny, czysty i orzeźwiający.",
  },
];
...
export default function Dictionary() {
  ...
  const filteredItems = DICTIONARY_DATA.filter(
    (item) =>
    ...
    <div className="space-y-12 py-10 md:py-16 max-w-3xl mx-auto">
      ...
      <section className="space-y-4 text-center md:text-left">
        ...
        <p className="text-hojicha/70 font-light max-w-xl">
          Twój podręczny przewodnik po japońskich terminach herbacianych. Poznaj
          język tradycji, którą sprowadzamy do Twojego domu.
        </p>
      </section>
      ...
      <div className="space-y-8 pt-4">
        {filteredItems.length > 0 ? (
          filteredItems.map((item, index) => {
            const currentBgColor = dictionaryColors[index % 4];
            ...
            return (
              ...
              >
                ...
                <div className="md:w-1/3 space-y-1">
                  <div
                    className={`w-3 h-3 rounded-xs shrink-0 mt-2 transition-transform duration-500 group-hover:scale-125 ${currentBgColor}`}
                  />
